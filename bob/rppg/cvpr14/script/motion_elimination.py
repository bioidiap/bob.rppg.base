...
def main(user_input=None):
  ...
  if args['cohface']:
    ...
    if not((args['--protocol'] == 'all') or (args['--protocol'] == 'clean')):
      logger.warning("Protocol should be either 'clean' or 'all' (and not {0})".format(args['--protocol']))
      sys.exit()
