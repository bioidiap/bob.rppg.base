...
base_expe_dir = 'experiments/paper/li-cohface-complete-wholeface/'
...
extract = ['./bin/cvpr14_extract_signals.py', 'cohface', '--dbdir', 'cohface', '--bboxdir', 'bounding-boxes', '--facedir', str(facedir), '--bgdir', str(bgdir), '--wholeface']
...
os.system('./bin/cvpr14_extract_signals.py cohface --dbdir cohface --bboxdir bounding-boxes --facedir ' + str(facedir) + ' --bgdir ' + str(bgdir) + ' --wholeface -v')
